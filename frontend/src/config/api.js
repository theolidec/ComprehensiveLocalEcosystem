...
const API_ENDPOINTS = {
  ...
  // Radiation endpoints
  RADIATION: {
    MEASUREMENTS: '/api/radiation/measurements',
    MEASUREMENTS_PUBLIC: '/api/radiation/measurements/public',
    LOCATIONS: '/api/radiation/locations',
    ANALYTICS_TIMESERIES: '/api/radiation/analytics/timeseries',
    ANALYTICS_BY_LOCATION: '/api/radiation/analytics/by-location',
    ANALYTICS_HEATMAP: '/api/radiation/analytics/heatmap',
    SETTINGS: '/api/settings/radiation',
  },

  // Finance endpoints
  FINANCE: {
    ACCOUNTS: '/api/finance/accounts',
    GROUPS: '/api/finance/groups',
    RULES: '/api/finance/rules',
    RULES_REORDER: '/api/finance/rules/reorder',
    TRANSACTIONS: '/api/finance/transactions',
    TRANSACTIONS_BULK: '/api/finance/transactions/bulk',
    ANALYTICS: '/api/finance/analytics',
    ANALYTICS_NET_WORTH: '/api/finance/analytics/net-worth',
    BUDGETS: '/api/finance/budgets',
    SETTINGS: '/api/settings/finance',
  },
...
export const API_URLS = {
  ...
  RADIATION_MEASUREMENTS: createApiUrl(API_ENDPOINTS.RADIATION.MEASUREMENTS),
  RADIATION_MEASUREMENTS_PUBLIC: createApiUrl(API_ENDPOINTS.RADIATION.MEASUREMENTS_PUBLIC),
  RADIATION_LOCATIONS: createApiUrl(API_ENDPOINTS.RADIATION.LOCATIONS),
  RADIATION_ANALYTICS_TIMESERIES: createApiUrl(API_ENDPOINTS.RADIATION.ANALYTICS_TIMESERIES),
  RADIATION_ANALYTICS_BY_LOCATION: createApiUrl(API_ENDPOINTS.RADIATION.ANALYTICS_BY_LOCATION),
  RADIATION_ANALYTICS_HEATMAP: createApiUrl(API_ENDPOINTS.RADIATION.ANALYTICS_HEATMAP),
  RADIATION_SETTINGS: createApiUrl(API_ENDPOINTS.RADIATION.SETTINGS),
  FINANCE_ACCOUNTS: createApiUrl(API_ENDPOINTS.FINANCE.ACCOUNTS),
  FINANCE_GROUPS: createApiUrl(API_ENDPOINTS.FINANCE.GROUPS),
  FINANCE_RULES: createApiUrl(API_ENDPOINTS.FINANCE.RULES),
  FINANCE_RULES_REORDER: createApiUrl(API_ENDPOINTS.FINANCE.RULES_REORDER),
  FINANCE_TRANSACTIONS: createApiUrl(API_ENDPOINTS.FINANCE.TRANSACTIONS),
  FINANCE_TRANSACTIONS_BULK: createApiUrl(API_ENDPOINTS.FINANCE.TRANSACTIONS_BULK),
  FINANCE_ANALYTICS: createApiUrl(API_ENDPOINTS.FINANCE.ANALYTICS),
  FINANCE_ANALYTICS_NET_WORTH: createApiUrl(API_ENDPOINTS.FINANCE.ANALYTICS_NET_WORTH),
  FINANCE_BUDGETS: createApiUrl(API_ENDPOINTS.FINANCE.BUDGETS),
  FINANCE_SETTINGS: createApiUrl(API_ENDPOINTS.FINANCE.SETTINGS),
